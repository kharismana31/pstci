...
$(function () {
  ...
  if (o.navbarMenuSlimscroll && typeof $.fn.slimscroll != 'undefined') {
    $(".navbar .slimScrollDiv").slimscroll({
      height: "250px",
      alwaysVisible: false,
      size: "3px"
    }).css("width", "100%");
...
function _init() {
  ...
  $.AdminLTE.layout = {
    ...
    fix: function () {
      ...
      var neg = $('.main-header').outerHeight() + $('.main-footer2').outerHeight();
      var window_height = $(window).height();
      var sidebar_height = $(".sidebar").height();
      //Set the min-height of the content and sidebar based on the
      //the height of the document.
      if ($("body").hasClass("fixed")) {
        $(".content-wrapper, .right-side").css('min-height', window_height - $('.main-footer2').outerHeight());
      } else {
