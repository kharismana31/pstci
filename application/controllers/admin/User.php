...
class User extends MY_Controller{
	public function __construct()
		...
		public function index(){
	        $data['countries'] = M_country::get();
			$this->template->load('template/template','admin/admin_user_regis', $data);
		}
...
//            thank you for registration, to verify please click the link below
			$dataemail['url'] = site_url("admin/User/verification/".$ver2.$pnumber.$this->generate());
