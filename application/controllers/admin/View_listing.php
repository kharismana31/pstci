<?php 
	...
	class View_listing extends MY_Controller
	{
		...
		public function table_list(){	
			$this->datatables->select('id,id AS prod_id,connect_owner,product_type,od,weight,grade_type,connect_stand,range_gen,spcl_condition,manufact_name,country,state');
