                    ...
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            <div class="pull-bottom bottom-left m-b-40">
                                <h1 class="text-white no-margin">Manage your <span class="semi-bold">Grades</span> here</h1>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="bg-master-lightest">
                                    <div class="container-fluid sm-p-l-20 sm-p-r-20 p-t-10 p-b-25">
                                        <div class="inner">
<!--                                            <h3 class="m-l-100">Main Grades</h3><hr />-->
                                            ...
                                            <div class="panel panel-featured m-r-20">
                                                <div class="panel-heading">
                                                    ...
                                                    <div class="btn-group pull-right m-b-10">
                                                        <a class="btn btn-default" href="<?= base_url('admin/Connection/add') ?>"><span class="fa fa-plus"></span> Add</a>
                                                        <a class="btn btn-default" id="edit_check"><span class="fa fa-edit"></span> Edit</a>
                                                        <button class="btn btn-default" id="delete_check"><span class="fa fa-trash"></span> Delete</button>
                                                    </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover" id="Data_table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="width:10%">Minimum Yields Metric</th>
                                                                <th style="width:10%">Minimum Yields Imperial</th>
                                                                <th style="width:10%">Type</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        table = $('#Data_table').DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                "url": '<?php echo site_url('admin/Grade/table_list'); ?>',
                "type": "POST"
            },
            "columns": [
                {"data": "id",width:0},
        ...
        $('#edit_check').click(function () {
            ...
            else if(id.length > 1)
            {
                ...
                window.location.href = "<?= base_url('admin/Connection/edit/') ?>" + id;
            }
        });
        ...
        $('#delete_check').click(function(){
            ...
            else
            {
                ...
                modalConfirm(function(confirm){
                    if(confirm){
                        $.ajax({
                            url:'<?php echo site_url('admin/Connection/delete')?>',
                            method:'POST',
                            data:{id:id},
                            success:function()
                            {
