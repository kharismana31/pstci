                    ...
                    <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                        <div class="inner">
                            <div class="pull-bottom bottom-left m-b-40">
                                <h1 class="text-white no-margin">Manage your <span class="semi-bold">Connections</span> here</h1>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="bg-master-lightest">
                                    <div class="container-fluid sm-p-l-20 sm-p-r-20 p-t-10 p-b-25">
                                        <div class="inner">
<!--                                            <h3 class="m-l-100">Main Connections</h3><hr />-->
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover" id="Data_table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="width:10%">Additional Feature</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        table = $('#Data_table').DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                "url": '<?php echo site_url('admin/Connection/table_list'); ?>',
                "type": "POST"
            },
            "columns": [
                {"data": "id",width:0},
