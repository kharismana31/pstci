	...
	<div class="container-fluid sm-p-l-20 sm-p-r-20 p-t-10 p-b-25">
		...
		<form id="form-login" role="form" method="post" action="<?php echo site_url('admin/C_broadcasting/send_message') ?>">
                                        ...
                                        <?php foreach ($user as $key) {?>
											<tr>
												<td class="v-align-middle">
													<div class="checkbox ">
														<input type="checkbox" name="name[]" value="<?php echo $key->fname;?>" id="<?php echo $key->id ;?>">
			...
			<div class="col-md-6">
				...
				<textarea name="msg" placeholder="Enter Your Message" class="form-control" style="min-height: 380px;" required /></textarea>
			</div>
		</div>
	</div>
	<div class="col-md-1">
