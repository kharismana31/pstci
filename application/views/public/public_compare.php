						...
						<div class="row">
							<div class="bg-master-lightest">
								<div class="container-fluid sm-p-l-20 sm-p-r-20 p-t-10 p-b-25">
									...
									<div class="col-md-4">
										<div class="card share  col1" data-social="item" data-toggle="modal" data-target="#ModalPipe">
											<div class="circle" data-toggle="tooltip" title="Remove" data-container="body">
											</div>
											<div class="card-header clearfix">
												<h5>Pipes</h5>
...
<div id="ModalPipe" class="modal fade" role="dialog">
