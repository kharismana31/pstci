...
return array(
    'Admin' => $baseDir . '/application/controllers/admin/Admin.php',
    'Api' => $baseDir . '/application/controllers/Api.php',
    'Approval' => $baseDir . '/application/controllers/admin/Approval.php',
    'Broadcasting' => $baseDir . '/application/controllers/admin/Broadcasting.php',
    'C_auth' => $baseDir . '/application/controllers/C_auth.php',
    'C_listing' => $baseDir . '/application/controllers/member/C_listing.php',
    'C_manage' => $baseDir . '/application/controllers/member/C_manage.php',
    'C_member' => $baseDir . '/application/controllers/member/C_member.php',
    'C_message' => $baseDir . '/application/controllers/member/C_message.php',
    'C_public' => $baseDir . '/application/controllers/public/C_public.php',
    'Connection' => $baseDir . '/application/controllers/admin/Connection.php',
    'Datatables' => $baseDir . '/application/libraries/Datatables.php',
    'EloquentModel' => $baseDir . '/application/models/EloquentModel.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'Grade' => $baseDir . '/application/controllers/admin/Grade.php',
    'Inbox' => $baseDir . '/application/controllers/admin/Inbox.php',
    'Listing' => $baseDir . '/application/controllers/admin/Listing.php',
    'Listing_analysis' => $baseDir . '/application/controllers/member/C_listing_analysis.php',
    'Listing_product' => $baseDir . '/application/controllers/member/C_listing_product.php',
    'M_admin' => $baseDir . '/application/models/M_admin.php',
    'M_approval' => $baseDir . '/application/models/M_approval.php',
    'M_auth' => $baseDir . '/application/models/M_auth.php',
    'M_broadcasting' => $baseDir . '/application/models/M_broadcasting.php',
    'M_connection' => $baseDir . '/application/models/M_connection.php',
    'M_country' => $baseDir . '/application/models/M_country.php',
    'M_dimension' => $baseDir . '/application/models/M_dimension.php',
    'M_grade' => $baseDir . '/application/models/M_grade.php',
    'M_grade_application' => $baseDir . '/application/models/M_grade_application.php',
    'M_listing' => $baseDir . '/application/models/M_listing.php',
    'M_manufacturer' => $baseDir . '/application/models/M_manufacturer.php',
    'M_member' => $baseDir . '/application/models/M_member.php',
    'M_product_type' => $baseDir . '/application/models/M_product_type.php',
    'M_setting' => $baseDir . '/application/models/M_setting.php',
    'M_state' => $baseDir . '/application/models/M_state.php',
    'M_statistic' => $baseDir . '/application/models/M_statistic.php',
    'Manufacturer' => $baseDir . '/application/controllers/admin/Manufacturer.php',
    ...
    'Registered' => $baseDir . '/application/controllers/admin/Registered.php',
    ...
    'Setting' => $baseDir . '/application/controllers/admin/Setting.php',
    'Statistic' => $baseDir . '/application/controllers/admin/Statistic.php',
    'Template' => $baseDir . '/application/libraries/Template.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/src/Template.php',
    'User' => $baseDir . '/application/controllers/admin/User.php',
    'View_listing' => $baseDir . '/application/controllers/admin/View_listing.php',
    'qwe' => $baseDir . '/application/controllers/qwe.php',
);
